...
query_emails_phishing = "SELECT emails_phishing FROM usuarios"
query_emails_total = "SELECT emails_total FROM usuarios"
...
print("Desviación estándar del número de email recibidos de phishing:", desviacion_emails_phishing)
